...
import { useGetArchivedCompanyReviewsQuery } from "@/app/state/api"
...
const CompanyReviewHistoryTab = () => {
  const [currentPage, setCurrentPage] = useState(1)
  const { data: archivedReviews = [] } = useGetArchivedCompanyReviewsQuery()
                  ...
                  <TableRow key={review.archiveId}>
                    ...
                    <TableCell className="align-top">
                      <div className="max-h-36 w-64 overflow-y-auto text-sm p-3 whitespace-normal">
                        <p className="text-xs text-muted-foreground">{review.Company.companyName}</p>
                        <span className="text-xs text-muted-foreground">{review.Company.fullAddress}</span>
                      </div>
                    </TableCell>
                    <TableCell className="align-top">
...
export default CompanyReviewHistoryTab
