...
import { Star, Building, ChevronLeft, ChevronRight } from "lucide-react"
...
const CompanyReviews = ({reviews}: ReviewsProps) => {
   ...
   return (
      <Card className="shadow-[0_4px_30px_rgba(0,0,0,0.1)] border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
